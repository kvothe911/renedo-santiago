...
function About() {
  return (
    <div className="relative bg-black w-full flex justify-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full gradient-80-to-transparent gradient-50-to-transparent"></div>
      <div
        id="about"
      ...
      >
        ...
        <h3 className="text-neutral-500 text-xl md:text-2xl font-bold sm:pt-0 lg:pt-6 mb-12 md:mb-16 lg:mb-0">
          Here you will find more information about me, what I do, and my
          current skills mostly in terms of programming and technology
        </h3>
        <div className="items-start">
            <h3 className="text-neutral-100 md:text-3xl text-2xl text-center font-bold sm:pt-0 lg:pt-12 pb-10 lg:pb-0">Know About me!</h3>
  ...
  <p className="text-neutral-100 text-sm sm:text-xl">
    ...
    opportunities in programming and ready to tackle challenges with the
    same dedication and spirit as in my lifeguarding career.
  </p>
  <div className="flex justify-center w-full md:mt-4 lg:mt-0">
    ...
    />
          ...
          <h3 className="text-neutral-100 md:text-3xl text-2xl text-center font-bold sm:pt-0 lg:pt-12 pb-10">My Skills</h3>
          <div>
