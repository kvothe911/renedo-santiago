      ...
      >
        ...
        <div className="mt-16">
          ...
          <div className="flex items-center mt-12">
            <span className="text-neutral-100 px-4 py-2 text-sm sm:text-xl border-2 border-lime-400 rounded-lg">{email}</span>
            <button
            ...
            {copySuccess && (
              <p className="text-neutral-100 absolute mt-28 ml-2">{copySuccess}</p>
            )}
          </div>
        </div>
      </div>
